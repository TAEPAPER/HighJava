...
public interface BoardMemDao {
  ...
  * @return 성공 : 1, 실패 : 0
  */
	public int updateBoard(Connection conn, BoardMemVO boardMemVo)throws SQLException;
	/**
	 ...
	 * @return 성공 : 1, 실패 :0
	 */
	public int deleteBoard(Connection conn, BoardMemVO boardMemVO)throws SQLException;
	/**

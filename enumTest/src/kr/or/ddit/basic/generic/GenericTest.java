...
public class GenericTest {
	...
	public static void main(String[] args) {
		...
		Integer rtnNg2 = (Integer)ng2.getValue();
		...
		//제네릭을 사용한 클래스에서 데이터를 꺼내올 때 형변환 없이 사용가능하다.
		...
		/*
		 * 제네릭을 사용했을 때와 사용하지 않았을 때의 오류가 발생하는 시점이 서로 다른경우의 예
		 * 
	...
	/*	MyGeneric<String> test2 = new MyGeneric<String>();
		...
		//컴파일 단계에서 오류가 발생 (컴파일 단계에서 오류가 나는게 더 좋다)

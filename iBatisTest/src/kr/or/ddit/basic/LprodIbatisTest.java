	...
	public static void main(String[] args) {
	    ...
	    try {
	    	...
	    	//1-2 환경 설정 파일을 읽어올 스트림객체 생성
	    	 Reader rd = Resources.getResourceAsReader("kr/or/ddit/ibais/config/sqlMapconfig.xml");
	    	 
	    	 //1-3 위에서 생성한 스트림 객체를 이용하여 환경설정 파일을 
	    	 //	   읽어서 실행한다.
	    	 //    iBatis를 처리할 객체가 반환된다.
	    	 SqlMapClient smc = SqlMapClientBuilder.buildSqlMapClient(rd);
	    	 rd.close(); //스트림 닫기//환경설정 마무리
	    	//--------------------------------------------------------------
...
//	    	 lvo.setLprod_nm(nm);
//	    	 
//	    	 //sqlMapClient 객체 변수를 이용해서 처리할 쿼리문을 
//	    	 //호출하여 실행한다.
...
//	    	 String gu = scan.next();
//	    	 //delete 형식) smc.delete("namespace값.id값",파리미터클래스)
//	    	 		 	 //	==> 반환값 : 성공한 레코드 수
//	    	 
...
//	    	 //==>이 메서드는 여러개의 레코드 각각을 VO에 담은 후 이 VO데이터를 List에 추가해 주는 
//	    	 //	   작업을 자동으로 수행한다.

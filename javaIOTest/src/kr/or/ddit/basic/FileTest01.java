...
public class FileTest01 {
	public static void main(String[] args) {
		...
		// File file = new File("d:/d_other/test.txt"); //구분문자로 '/'를 사용
		File file1 = new File("d:\\d_other\\test.txt"); // 구분문자로 '\'를 사용

		System.out.println("파일명 : " + file1.getName());// 잘생성되었나 확인차원
		 ...
		 * 
		 */
		File file5 = new File("d:/d_other/연습용"); // 아직 안만들어졌으니까 파일도 폴더도 아니야

...
public class UdpClient {
	public static void main(String[] args) {
		...
		try {
			DatagramSocket socket = new DatagramSocket(); // 기본 생성자로 만들어
			// 접속할 곳의 주소 생성
			InetAddress address = InetAddress.getByName("localhost"); // 127.0.0.1 (서버의 ip 기재)
			while (true) { // 계속 메시지 보낼거니까 무한반복문
				// 전송할 메시지 입력
